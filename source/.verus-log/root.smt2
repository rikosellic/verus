...
(assert
 (distinct fuel%vstd!array.group_array_axioms. fuel%vstd!function.group_function_axioms.
...
;; Datatypes
(declare-datatypes ((adts_eq!Thing. 0) (adts_eq!Car. 0) (tuple%0. 0)) (((adts_eq!Thing./Thing))
  ((adts_eq!Car./Car (adts_eq!Car./Car/?thing adts_eq!Thing.) (adts_eq!Car./Car/?four_doors
     Bool
   ))
  ) ((tuple%0./tuple%0))
))
(declare-fun adts_eq!Car./Car/thing (adts_eq!Car.) adts_eq!Thing.)
(declare-fun adts_eq!Car./Car/four_doors (adts_eq!Car.) Bool)
(declare-const TYPE%adts_eq!Thing. Type)
(declare-const TYPE%adts_eq!Car. Type)
(declare-fun Poly%adts_eq!Thing. (adts_eq!Thing.) Poly)
(declare-fun %Poly%adts_eq!Thing. (Poly) adts_eq!Thing.)
(declare-fun Poly%adts_eq!Car. (adts_eq!Car.) Poly)
(declare-fun %Poly%adts_eq!Car. (Poly) adts_eq!Car.)
(declare-fun Poly%tuple%0. (tuple%0.) Poly)
(declare-fun %Poly%tuple%0. (Poly) tuple%0.)
(assert
 (forall ((x adts_eq!Thing.)) (!
   (= x (%Poly%adts_eq!Thing. (Poly%adts_eq!Thing. x)))
   :pattern ((Poly%adts_eq!Thing. x))
   :qid internal_adts_eq__Thing_box_axiom_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x TYPE%adts_eq!Thing.)
    (= x (Poly%adts_eq!Thing. (%Poly%adts_eq!Thing. x)))
   )
   :pattern ((has_type x TYPE%adts_eq!Thing.))
   :qid internal_adts_eq__Thing_unbox_axiom_definition
)))
(assert
 (forall ((x adts_eq!Thing.)) (!
   (has_type (Poly%adts_eq!Thing. x) TYPE%adts_eq!Thing.)
   :pattern ((has_type (Poly%adts_eq!Thing. x) TYPE%adts_eq!Thing.))
   :qid internal_adts_eq__Thing_has_type_always_definition
)))
(assert
 (forall ((x adts_eq!Car.)) (!
   (= x (%Poly%adts_eq!Car. (Poly%adts_eq!Car. x)))
   :pattern ((Poly%adts_eq!Car. x))
   :qid internal_adts_eq__Car_box_axiom_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x TYPE%adts_eq!Car.)
    (= x (Poly%adts_eq!Car. (%Poly%adts_eq!Car. x)))
   )
   :pattern ((has_type x TYPE%adts_eq!Car.))
   :qid internal_adts_eq__Car_unbox_axiom_definition
)))
(assert
 (forall ((x adts_eq!Car.)) (!
   (= (adts_eq!Car./Car/thing x) (adts_eq!Car./Car/?thing x))
   :pattern ((adts_eq!Car./Car/thing x))
   :qid internal_adts_eq!Car./Car/thing_accessor_definition
)))
(assert
 (forall ((x adts_eq!Car.)) (!
   (= (adts_eq!Car./Car/four_doors x) (adts_eq!Car./Car/?four_doors x))
   :pattern ((adts_eq!Car./Car/four_doors x))
   :qid internal_adts_eq!Car./Car/four_doors_accessor_definition
)))
(assert
 (forall ((x adts_eq!Car.)) (!
   (has_type (Poly%adts_eq!Car. x) TYPE%adts_eq!Car.)
   :pattern ((has_type (Poly%adts_eq!Car. x) TYPE%adts_eq!Car.))
   :qid internal_adts_eq__Car_has_type_always_definition
)))
(assert
 (forall ((x tuple%0.)) (!
...
;; Function-Def adts_eq::one
;; ..\examples\adts_eq.rs:16:1: 16:9 (#0)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 Bool)
 (declare-const tmp%2 Bool)
 (declare-const c1@ adts_eq!Car.)
 (declare-const c2@ adts_eq!Car.)
 (declare-const t1@ adts_eq!Thing.)
 (declare-const t2@ adts_eq!Thing.)
 (assert
  fuel_defaults
 )
 ;; assertion failed
 ...
 (assert
  (not (=>
    (= c1@ (adts_eq!Car./Car (%Poly%adts_eq!Thing. (Poly%adts_eq!Thing. adts_eq!Thing./Thing))
      (%B (B true))
    ))
    (=>
     (= c2@ (adts_eq!Car./Car (%Poly%adts_eq!Thing. (Poly%adts_eq!Thing. adts_eq!Thing./Thing))
       (%B (B true))
     ))
     (=>
      (= tmp%1 (= c1@ c2@))
      (and
       ...
       (=>
        tmp%1
        (=>
         (= t1@ adts_eq!Thing./Thing)
         (=>
          (= t2@ adts_eq!Thing./Thing)
          (=>
           (= tmp%2 (= t1@ t2@))
           (=>
            %%location_label%%1
